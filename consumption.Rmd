...
# some readings are incomplete, if we miss a meter or loose the readings
# for simplicity, just drop those readings
#meter.readings <- na.omit(meter.readings)
...
```
```{r plot_readings, echo=FALSE, message=FALSE, warning=FALSE}
...
print(raw)
```
```{r plot_seasonal, echo=FALSE, message=FALSE, warning=FALSE}
